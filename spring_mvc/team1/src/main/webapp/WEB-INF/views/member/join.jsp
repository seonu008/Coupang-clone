...
<html lang="en">
  ...
  <body>
    <form method="post" action="/team1/join/JoinProcess.do">
          ...
          <div class="member-login _loginRoot">
            ...
            <div class="login__form _loginForm">
              ...
              <div
                ...
                "
              >
                <div class="title">쿠팡 서비스약관에 동의해주세요</div>
                <div class="checkall">
                  ...
                  <span class="message">
                    동의에는 필수 및 선택 목적(광고성 정보 수신 포함)에 대한
                    동의가 포함되어 있으며, 선택 목적의 동의를 거부하시는
                    경우에도 서비스 이용이 가능합니다.
                  </span>
                </div>
                <div class="error-tip">
