...
.member__field-wrap:before, .member__field-wrap:after {
	overflow: hidden;
	content: "";
	display: table;
	_display: block;
...
.member__input-field:before, .member__input-field:after {
	overflow: hidden;
	content: "";
	display: table;
	_display: block;
...
.member__input-border:focus, .member__input-border--focus {
	outline: 0;
...
.member__input-wrap, .member__input-wrap-v2 {
	*zoom: 1;
	display: block;
	position: relative;
	height: 48px;
...
.member__input-wrap:before, .member__input-wrap-v2:before,
	.member__input-wrap:after, .member__input-wrap-v2:after {
	overflow: hidden;
	content: "";
	display: table;
	_display: block;
...
.member__util-trigger[disabled], .member__util-trigger[readonly] {
	background-color: #eee;
}

.member__input-area__overlap-label, .member__input {
	width: 100%;
	padding: 16px 0 12px;
	border: 0 none;
...
.member__expand-field:before, .member__expand-field:after {
	overflow: hidden;
	content: "";
	display: table;
	_display: block;
...
.member__field-wrap .member__input-guide-line, .member__input-field-wrap .member__input-guide-line,
...
body.page-login-play .member__input-wrap, body.page-login-play .member__input-wrap-v2,
...
body.page-login-play .member__input-wrap.member__input-wrap--error, body.page-login-play .member__input-wrap--error.member__input-wrap-v2,
...
body.page-login-play .member__input-area__overlap-label, body.page-login-play .member__input
	{
	height: 44px;
...
body.page-login-play .member__input-area__overlap-label[readonly], body.page-login-play .member__input[readonly]
	{
...
body.page-login-play .member__input-area__overlap-label:-webkit-autofill,
	body.page-login-play
        .member__input-area__overlap-label:-webkit-autofill:hover, body.page-login-play
        .member__input-area__overlap-label:-webkit-autofill:focus, body.page-login-play .member__input:-webkit-autofill,
	body.page-login-play .member__input:-webkit-autofill:hover, body.page-login-play .member__input:-webkit-autofill:focus
	{
...
body.page-login-play
        .member__input-area__overlap-label#login-captcha-input, body.page-login-play .member__input#login-captcha-input
	{
	text-indent: 16px;
}
...
body.page-login-play
        .member__input-group--util
        .member__util-trigger[disabled], body.page-login-play
        .member__input-group--util
		...
		<div class="member-wrapper member-wrapper--flex">
			<header class="member-header">
				<h1 class="member-logo">
					<a href="/team1/" class="member-logo__link"> <img
						src="//static.coupangcdn.com/image/static/login/logo-coupang.x2.20201201.png"
						width="100%" height="100%"
						class="member-logo__img-fixer need_size" alt="coupang" />
					</a>
				</h1>
			</header>
					...
					<div class="login__form _loginForm">
						<div class="login__content login__content--input">
							<div class="member__field-wrap">
								<div class="member__input-field">
									<label class="member__input-wrap member__input-wrap-v2"
										for="login-email-input"> <span
										class="member__input-group member__input-group--icon-label">
											<i class="member__sprite member__sprite--email"></i>
									</span> <span class="member__input-group"> <input type="email"
											class="member__input _loginIdInput ui-autocomplete-input"
											maxlength="80" name="username" id="login-email-input"
											value="" placeholder="아이디(이메일)" autocomplete="off" />
									</span>
									</label>
								</div>
							...
							<div class="member__field-wrap">
								<div class="member__input-field member__input-field--util">
									<label class="member__input-wrap member__input-wrap-v2"
										for="login-password-input"> <span
										class="member__input-group member__input-group--icon-label">
											<i class="member__sprite member__sprite--password"></i>
									</span> <span class="member__input-group"> <input
											type="password" class="member__input _loginPasswordInput"
											value="" name="password" id="login-password-input"
											placeholder="비밀번호" />
									</span>
									</label>
								</div>
						...
						<div class="login__content login__content--util">
							<label for="login-keep-state"
								...
								type="checkbox" name="remember-me" id="login-keep-state" />
								<span class="member__checkbox__label">자동로그인</span>
							</label> <a
								class="login__link login__link--find-id-password _loginFindIdPwLink">
								아이디(이메일)/비밀번호 찾기 <i
								class="member__sprite member__sprite--right-arrow"></i>
							</a>
							<div class="login__keep-message _loginRememberMessage"
								style="display: none">
								<i class="member__sprite member__sprite--triangle"></i> 개인 정보
								보호를 위해 본인 기기에서만 이용해 주세요.
							</div>
						</div>
						<div class="login__content login__content--trigger">
							...
							<a href="./join/Join.do"
								class="login__button login__button--join _loginJoinLink">회원가입</a>
						</div>
					</div>
				</div>
			</div>
